    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '28px', width: '100%', maxWidth: '1280px', margin: '0 auto' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
          ...
          <div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
              <span className="glow-badge glow-badge-green" style={{ fontSize: '9px', padding: '2px 8px' }}>Component 4</span>
      ...
      <div className="glass-card" style={{ padding: '28px' }}>
        ...
        <div className="code-window">
          ...
          <div style={{ color: '#64748b' }}># Generated by HEART Framework Self-Healing Synthesis Engine (C4)</div>
